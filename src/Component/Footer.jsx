  ...
  return (
    <footer className="bg-neutral-300 text-gray-600 py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div>
          <h2 className="text-2xl font-bold mb-4">Pets Food store</h2>
          <p className="text-gray-400">
            Your one-stop shop for all your pet's food needs. We provide a variety of healthy and delicious options to keep your furry pets happy and healthy.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-gray-700 mb-2">Email: anjali123@gmail.com</p>
          <p className="text-gray-700">Phone: +91 98556641200</p>
        </div>
      </div>
      <div className="border-t border-gray-700 mt-8 pt-4 text-center text-gray-700">
        <p>&copy; 2024 Latest Pet food Items  Store. All rights reserved.</p>
      </div>
    </footer>
  );
};
