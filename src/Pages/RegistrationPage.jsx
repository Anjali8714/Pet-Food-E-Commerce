...
const onSubmit = (values) => {
  ...
  return (
   ...
   initialValues={{username : '' , email :'' , password :'' ,cart : [], order : [] , status : true}}
    ...
    >
          ...
          <Field type="text" placeholder='Username' name='username' className='border-none outline-none flex-1 pl-2 bg-transparent'/>
          </div>
        ...
        <div className='flex items-center border border-gray-300 p-3 rounded bg-gray-100'>
          ...
          <button type='submit' className='w-full p-3 bg-blue-500 text-white rounded-3xl hover:bg-blue-600'>
          Sign UP
        </button>
        </Form>
      </Formik>
